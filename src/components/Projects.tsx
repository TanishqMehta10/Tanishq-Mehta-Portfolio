...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      title: "AI-Based Stock Trading Decision System",
      description: "An intelligent stock trading system using Q-Learning reinforcement learning to make optimal trading decisions based on real-time market data analysis.",
      image: "/Stock.png",
      tech: ["Python", "YFinance", "Q-Learning", "Reinforcement Learning", "Streamlit"],
      gradient: "from-green-600 to-emerald-500",
      link: "https://stock-trading-decision-system.streamlit.app/",
      github: "https://github.com/TanishqMehta10/Stock-Trading-Decision-System-using-Q-Learning",
    ...
    },
    {
      ...
      image: "/ResQnow image.png",
      tech: ["React", "Tailwind CSS", "MySQL", "Ethereum", "Node.js"],
      gradient: "from-purple-600 to-pink-600",
      link: "https://resqnow-fast.vercel.app/",
      github: "https://github.com/TanishqMehta10",
      alwaysShowLinks: true
    },
    {
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <motion.div
                    ...
                    initial={project.alwaysShowLinks ? { y: 0, opacity: 1 } : { y: -20, opacity: 0 }}
                    animate={project.alwaysShowLinks ? { y: 0, opacity: 1 } : undefined}
                  >
                    {project.github && (
                      <motion.a
                        href={project.github}
