          ...
          <div className="flex">
            ...
            <div className="font-mono text-[13px] text-gray-300 leading-relaxed space-y-3">
              ...
              <p>
                ...
                <span className="text-gray-400">Exploring new tech, Open to work.</span>
              </p>
            </div>
          </div>
        </RetroWindow>
        ...
        >
          <div className="grid grid-cols-3 gap-y-6 gap-x-2 text-center text-gray-300 font-mono text-[11px]">
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              ...
              <span className="group-hover:text-cyan-300 transition-colors hidden md:block">Web Dev</span>
            ...
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              ...
              <span className="group-hover:text-pink-300 transition-colors">RL</span>
            </div>
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              <div className="relative">
              ...
              <span className="group-hover:text-yellow-300 transition-colors">Team Building</span>
            </div>
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              <div className="relative">
            ...
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              ...
              <span className="group-hover:text-indigo-300 transition-colors">Good Presenter</span>
            </div>
          </div>
        </RetroWindow>
      </div>
