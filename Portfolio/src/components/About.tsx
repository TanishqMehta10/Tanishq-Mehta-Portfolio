        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                <motion.div
                  className="relative w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 p-1 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500"
